...
const ResumeSection = () => (
  <SectionWrapper id="resume" className="text-center">
    ...
    >
      ...
      <a
        href="#"
        className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3 rounded-lg font-medium hover:opacity-90 transition-opacity glow-box text-lg"
      >
        <FileDown size={20} />
        Download Resume (PDF)
      </a>
